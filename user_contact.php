...
<!--Rgistered Member-->
<center>
  <div class="container  text-center" id="forget231">
...
<ul class="nav nav-tabs">
       ...
       <li class="nav-item">
          ...
          <li class="nav-item" style="	box-shadow: 0 -3px 4px -1px #333; ">
            <a class="nav-link active " href="user_contact.php"><h4 class="text-left  pl-1" id="forget"><span  style="font-family: 'rubik', sans-serif ">Contact</span></h4></a>
       </li>
  ...
  <div class="sched-list">
          ...
          <thead  style="word-spacing:0px">
              <tr>
                <th class="pr-1  pl-0">Name</th>
                <th class="pr-1  pl-0">Email</th>
                <th class="pr-2  pl-0">Subject</th>
            ...
            <tbody>
              <tr>
                  <td class="pr-1  pl-0"><?php echo $row['Name'];?></td>
                  <td class="pr-1  pl-0" style="color:#FF3031"><?php echo $row['Email'];?></td>
                  <td class="pr-3  pl-2"><?php echo $row['Subject'];?></td>
