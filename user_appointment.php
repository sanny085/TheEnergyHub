...
<!--Rgistered Member-->
<center>
  <div class="container  text-center" id="forget341">
...
<ul class="nav nav-tabs">
   <li class="nav-item">
     <a class="nav-link " href="user_member.php"><h4 class="text-left" id="forget1"><span  style="font-family: 'rubik', sans-serif; ">Members</span></h4></a>
   </li>
     <li class="nav-item" style="	box-shadow: 0 -3px 4px -1px #333; ">
  <a class="nav-link active" href="user_appointment.php"> <h4 class="text-left  pl-1" id="forget"><span  style="font-family: 'rubik', sans-serif ">Appointment</span></h4></a>
   </li>
   <li class="nav-item">
    ...
    <table class="table table-hover ">
        <thead  style="word-spacing:0px">
          <tr>
            ...
            <th class="pr-3  pl-2"> Phone </th>
            <th class="pr-3  pl-2" style="width:150px"> Date </th>
            <th class="pr-3  pl-2"> Time </th>
            <th class="pr-4  pl-2"> Message </th>
          </tr>
        </thead>
        <?php
      ...
      <tbody>
            <tr>
                <td class="pr-3  pl-2" ><?php echo $row['Fname']; ?></td>
                <td class="pr-3  pl-2" ><?php echo $row['Lname']; ?></td>
                <td class="pr-3  pl-2"  style="color:#2475B0"><?php echo $row['Phone']; ?></td>
                <td class="pr-2  pl-0" id="name" style="color:#E8290B;"><?php echo $row['Date']; ?></td>
                <td class="pr-2  pl-0"  ><?php echo $row['Time']; ?></td>

                <div class="media m-0">
                   <td class="p-0" >
                    <div class="media-left">
                       <div class="media-body    pl-1" id="name12">
